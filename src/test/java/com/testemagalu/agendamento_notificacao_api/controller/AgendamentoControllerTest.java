package com.testemagalu.agendamento_notificacao_api.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.datatype.jsr310.JavaTimeModule;
import com.testemagalu.agendamento_notificacao_api.business.AgendamentoService;
...
import com.testemagalu.agendamento_notificacao_api.infrastructure.enums.StatusNotificacaoEnum;
...
public class AgendamentoControllerTest {
    ...
    void setUp() {
        ...
        agendamentoRecord = new AgendamentoRecord("email@email.com", "55987968907",
                "Favor retornar a loja com urgência", LocalDateTime.of(2025,01,02,11,01,01 ));

        agendamentoRecordOut = new AgendamentoRecordOut(1l,"email@email.com", "55987968907",
                "Favor retornar a loja com urgência", LocalDateTime.of(2025,01,02,11,01,01),
